...
if(isset($_POST['submit'])){
   ...
   $status = 'Enable';
   $q = "INSERT INTO `syllabus`(`course_id`,`branch_id`,`semester`,`file`,`status`) VALUES('$course_id','$branch_id','$semester','$file','$status')";
   $result = mysqli_query($conn,$q);
   if($result>0){
    ?>
    <div class =  "alert alert-success">Inserted Succesfully</div>
    <?php
   }else{
    ?>
