...
if(isset($_POST['submit'])){
  ...
  $status='Enable';
  $q = "INSERT INTO `datesheet`(`course_id`,`branch_id`,`semester`,`Title`,`file`,`status`) VALUES('$course_id','$branch_id','$semester','$Title','$file','$status')";
    ...
    <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <select class="form-select form-control" aria-label="Default select example" name="branch_id" >
            <option selected diabled value="">Select your branch</option>
            <?php
            include "config.php";
