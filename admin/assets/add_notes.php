...
if(isset($_POST['submit'])){
  ...
  $status='Enable';
  $q = "INSERT INTO `notes`(`course_id`,`branch_id`,`semester`,`title`,`description`,`file`,`status`) VALUES('$course_id','$branch_id','$semester','$title','$description','$file','$status')";
...
<div class="container">
    ...
    <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea name="description" id="description" cols="70" rows="8" class="form-control"></textarea>
        </div>
